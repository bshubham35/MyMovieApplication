...
namespace MyMovieApp.Data.Migrations
{
    ...
    [Migration("20220601075110_movieapplication2")]
    partial class movieapplication2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyMovieApp.Entity.BookingModel", b =>
                {
            ...
            modelBuilder.Entity("MyMovieApp.Entity.BookingModel", b =>
                {
                    ...
                    b.HasOne("MyMovieApp.Entity.ThetreModel", "thetreModel")
                        .WithMany()
                        .HasForeignKey("ThetreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyMovieApp.Entity.UserModel", "User")
                        .WithMany()
